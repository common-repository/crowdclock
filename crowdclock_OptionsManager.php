...
class crowdclock_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'crowdclock'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'crowdclock'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'crowdclock'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'crowdclock'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'crowdclock');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'crowdclock'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'crowdclock');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'crowdclock'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'crowdclock') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'crowdclock');
            case 'false':
                return __('false', 'crowdclock');

            case 'Administrator':
                return __('Administrator', 'crowdclock');
            case 'Editor':
                return __('Editor', 'crowdclock');
            case 'Author':
                return __('Author', 'crowdclock');
            case 'Contributor':
                return __('Contributor', 'crowdclock');
            case 'Subscriber':
                return __('Subscriber', 'crowdclock');
            case 'Anyone':
                return __('Anyone', 'crowdclock');
        }
        return $optionValue;
    }
